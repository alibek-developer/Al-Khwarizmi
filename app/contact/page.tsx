...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setSubmitError("Tarmoq xatosi. Iltimos internet aloqangizni tekshiring.");
      setIsSubmitting(false);
    }
  };
        ...
        <section className="relative py-24 md:py-32 bg-white dark:bg-slate-950 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg max-w-xl mx-auto mb-2 leading-relaxed">
              Choose your course, fill in your details, and our team will reach
              out within 24 hours.
            </p>
            <p className="text-slate-400 dark:text-slate-600 text-base italic max-w-xl mx-auto">
              Kursni tanlang, ma'lumotlaringizni kiriting — jamoamiz 24 soat
              ichida bog'lanadi.
            </p>
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="bg-white dark:bg-slate-950 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden">
                  ...
                  <div className="px-8 pt-8 pb-6 border-b border-slate-100 dark:border-slate-800">
                    ...
                    <p className="text-slate-400 text-sm">
                      Enroll Now — Kurs tanlang va ma'lumotlaringizni kiriting
                    </p>
                  </div>
                      ...
                      <div className="mb-6 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-5 flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-emerald-600 dark:text-emerald-400 text-xs mt-0.5">
                            Jamoamiz 24 soat ichida siz bilan bog'lanadi. / Our
                    ...
                    <form onSubmit={handleSubmit} className="space-y-7">
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <p
                                      className={`text-[10px] italic mt-0.5 ${isSelected ? "text-blue-500" : "text-slate-400"}`}
                                    >
                                      {course.labelUz}
                                    </p>
                                  </div>
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <p className="text-xs text-slate-400 leading-relaxed max-w-xs">
                          * Majburiy maydonlar. Ma'lumotlaringiz faqat
              ...
              <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        icon: Mail,
                        label: "Email",
                        value: "info@alkhorazmiy.uz",
                        href: "mailto:info@alkhorazmiy.uz",
                      },
                      {
                        icon: MapPin,
                        label: "Manzil",
                        value: "Shovot tumani, Xorazm viloyati",
                        href: null,
                      },
                      {
                        icon: Clock,
                        label: "Ish vaqti",
                        value: "Du–Shan: 9:00 – 18:00",
                        href: null,
                      },
                ...
                <div className="bg-blue-600 rounded-3xl p-6 text-white">
                  ...
                  <p className="text-blue-100 text-xs leading-relaxed mb-0.5">
                    Fast response guaranteed
                  </p>
                  <p className="text-blue-200 text-xs leading-relaxed">
                    Arizangiz qabul qilingandan so'ng jamoamiz{" "}
                    <strong className="text-white">24 soat</strong> ichida siz
                    bilan bog'lanadi.
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  {openFaq === idx && (
                    <div className="px-5 pb-5 bg-white dark:bg-slate-900">
                      <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-1.5">
                        {faq.a}
                      </p>
