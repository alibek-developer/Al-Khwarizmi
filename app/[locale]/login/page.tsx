...
const ADMIN_EMAIL = process.env.NEXT_PUBLIC_ADMIN_EMAIL || "inoqdost478@gmail.com";
const ADMIN_PASSWORD = process.env.NEXT_PUBLIC_ADMIN_PASSWORD || "itparkadmin";
            ...
            <div className="px-8 pt-8 pb-7">
              ...
              <div className="flex items-center justify-center gap-3 mb-6 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400">
                  ...
                  <span className="text-[11px] font-bold">{t('role_admin')}</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-50 dark:bg-violet-500/10 text-violet-600 dark:text-violet-400">
                  ...
                  <span className="text-[11px] font-bold">{t('role_mentor')}</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400">
                  <Users className="w-3.5 h-3.5" />
                  <span className="text-[11px] font-bold">{t('role_student')}</span>
                </div>
              </div>
                  ...
                  >
                    ...
                    {loading ? (
                      <>
                        ...
                        <span>{t('submit_loading')}</span>
                      </>
                    ) : (
                      <>
                        <span>{t('submit_idle')}</span>
