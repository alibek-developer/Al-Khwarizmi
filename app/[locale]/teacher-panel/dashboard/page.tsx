...
export default function TeacherDashboard() {
	...
	const stats = [
		{
			labelKey: 'stat_my_groups',
			subKey: 'stat_active_groups',
			value: groups.length,
			icon: Users,
		...
		{
			labelKey: 'stat_total_students',
			subKey: 'stat_students_short',
			value: studentCount,
			icon: GraduationCap,
		...
		{
			labelKey: 'stat_todays_lessons',
			subKey: 'stat_lessons_today',
		...
		{
			labelKey: 'stat_activity',
			subKey: 'stat_avg_attendance',
			value: '98%',
			icon: TrendingUp,
