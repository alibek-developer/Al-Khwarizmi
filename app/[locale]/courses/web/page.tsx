...
const prices = [
	{
		...
		featuresUz: ['20 dars', "Online o'qish", 'Sertifikat', '1 oy support'],
		highlight: false,
	},
	{
		name: 'Standard',
...
export default function WebDevelopmentPage() {
	const t = useTranslations('course_web')
					...
					<div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
						<div className='max-w-3xl'>
							...
							<div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
								{[
									{ icon: Clock, value: '6 ' + t('stat_duration').toLowerCase(), key: 'stat_duration' },
									{ icon: BookOpen, value: '48', key: 'stat_lessons' },
									{ icon: Users, value: '1,250+', key: 'stat_students' },
