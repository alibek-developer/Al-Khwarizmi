...
const prices = [
	{
		...
		featuresUz: ['16 dars', "Online o'qish", 'Sertifikat', '1 oy support'],
		highlight: false,
	},
	{
		name: 'Standard',
...
export default function DataSciencePage() {
	const t = useTranslations('course_datascience')
					...
					<div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full'>
						<div className='max-w-3xl'>
							...
							<div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
								{[
									{ icon: Clock, value: '4 ' + t('stat_duration').toLowerCase(), key: 'stat_duration' },
									{ icon: BookOpen, value: '32', key: 'stat_lessons' },
									{ icon: Users, value: '980+', key: 'stat_students' },
									{ icon: Star, value: '4.8', key: 'stat_rating' },
