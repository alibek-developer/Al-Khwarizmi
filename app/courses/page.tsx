          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-xs font-bold px-4 py-2 rounded-full mb-8 tracking-widest uppercase">
                ...
                45+ Kurs mavjud / Courses Available
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  { icon: TrendingUp, value: '98%', label: 'Job placement' },
                  { icon: Clock, value: '6 weeks–6 mo', label: 'Duration range' },
                ].map(({ icon: Icon, value, label }) => (
                  <div key={label} className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-3.5 py-2 rounded-xl">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
            ...
            {showFilters && (
              <div className="pt-3 flex items-center gap-2 flex-wrap">
                <span className="text-xs text-slate-400 font-medium">Daraja:</span>
                {levels.map((lvl) => (
                  <button
                    key={lvl}
                ...
                {filtered.map((course, idx) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-xs text-blue-600 italic mb-2">{course.titleUz}</p>
